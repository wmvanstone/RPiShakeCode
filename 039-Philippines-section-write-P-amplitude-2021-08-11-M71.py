...
DETAILS = [6.4547, 126.7421,65.6,'2021-08-11 17:46:14', 109.768296125, 860.924, 'M7.1 63 km E of Pondaguitan, Philippines','https://earthquake.usgs.gov/earthquakes/eventpage/us6000f48v/executive']
...
EQZ= DETAILS[2]
EQTIME = DETAILS[3]
FILE_STEM = 'Philippines-2021-08-11-M71'
MAGNITUDE = DETAILS[6][0:4]

RESP="VEL" # DISP, VEL or ACC
...
DURATION = 1800  # Length in seconds of data to plot after origin time
...
STEP = 1.25 # step in degrees between seismometers
...
F3 = 0.1  # High-pass filter corner for seismometers from 90 degrees
F4 = 3.0  # Low-pass filter corner 

#EXCLUDE=['R3C08','RC28B','R2683','RDD06','RBFA3','R7A14','R21C3','R4491','RAC91','RF985','RB669']
EXCLUDE=['RBBE5','RDF62','R02DC','R06CD','R0306','R720B','R4457','R2683','RF737','R47BE','R4B41','RD878','R2DD9']
EXCLUDE+=['R8473','RADA1','R3569','R6EF2','R38FD','REACE','REFF7','R31B9','RC303','R21B0','RED68','R50BE','RDDC7']
EXCLUDE+=['RE0CC','RA71B','S4458','R2231','RCDAD','RC57A','R351D','R976A','RCC6E']

NETWORK_DATA = "ShakeNetwork2021.csv" # data file containing seismometer names and locations, different format to 2019 data
GLOBE_PHASES = sorted([
    # Phase, distance
    ('P', 26),
    ('PP', 60),
...
# Add the inset picture of the globe at x, y, width, height, as a fraction of the parent plot
    ax1 = fig.add_axes([0.70, 0.58, 0.3, 0.3], polar=True)
