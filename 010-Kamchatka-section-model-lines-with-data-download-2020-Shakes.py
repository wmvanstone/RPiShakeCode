...
LABEL = "M5.9 Kamchatka" # Title to plot on figure
EVT_TIME = "2020-02-20 18:57:36"  # origin time of event
EVT_LAT = 53.638 # Latitude of event
EVT_LON = 160.776 # Longitude of event
EVT_Z = 33.5 # Depth of event in km
FILE_STEM = 'Kamchatka' # folder name for saving mseed data files
...
STEP = 1.125 # step in degrees between seismometers
...
F4 = 1.5  # Low-pass filter corner 
MODEL = 'iasp91'  # Velocity model to predict travel-times through
EXCLUDE = ['RDCA5', 'R25AC', 'R623F', 'R350D', 'R4F29', 'RADF8', 'R5C4C', 'R7F64', 'R2508', 'R8EFE', 'R2E8D', 'R6F29', 'R4355', 'R6324', 'RE063', 'RAE6A', 'REB59', 'R7143', 'R6F15', 'R49B6', 'RFF8B', 'R026F',
