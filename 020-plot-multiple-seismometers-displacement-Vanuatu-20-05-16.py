...
#PHASES = sorted(["Pdiff", "PKP", "PKIKP", "PcP", "ScP", "ScS", "PKiKP", "SKiKP", "SKP", "SKS"]) # list of phases for which to compute theoretical times
...
#        st.remove_response(pre_filt=pre_filt,output="DISP",water_level=40,taper=True)#, plot=True)
